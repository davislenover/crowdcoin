...
/**
 * A translation class between a {@link java.sql.ResultSet} and a {@link javafx.scene.control.TableView} intended to directly act as a model class for said {@link java.sql.ResultSet}
 */
public class QueryModelClass {
    ...
    /**
     * Creates a new {@link QueryModelClass}
     ...
     */
    public QueryModelClass(ResultSet resultSet) {
