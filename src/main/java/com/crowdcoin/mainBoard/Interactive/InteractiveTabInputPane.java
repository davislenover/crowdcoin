...
/**
 * InteractiveTabInputPane is an extension of InteractiveInputPane. TabPanes dictate how the user interacts with the right side of a Tab
 */
public class InteractiveTabInputPane extends InteractiveInputPane {
    ...
    /**
     * Creates an InteractiveTabInputPane object. InteractiveTabInputPane's define how a Tab interacts with the rightmost display beside the TableView (by convention).
     * This object is typically used in tandem with a Tab object (as a Tab handles invocation of applying InteractiveTabInputPane to GridPanes)
     */
    public InteractiveTabInputPane() {
    }

    /**
     * Add a button to InteractiveTabInputPane. When applyInteractivePane() is called, all buttons added will be applied to the corresponding button GridPane
    ...
    public boolean addButton(String buttonText, InteractiveButtonActionEvent eventHandler) {
        // Overriding addButton enables pass-through of the InteractiveTabInputPane to InteractiveButton
