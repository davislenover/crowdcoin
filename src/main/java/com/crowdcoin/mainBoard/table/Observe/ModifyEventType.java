...
public enum ModifyEventType implements GeneralEventType {
    ...
    APPLIED_NEW_VIEW("Applied new set of rows to a given TableView"),NEW_COLUMN("Added a new column to a database table"),REMOVED_COLUMN("Removed a column from a database table"),ADDED_USER("Added a user to the database"),REMOVED_USER("Removed a user from the database"),QUERY_COMPLETED("Generic query event has occurred");
