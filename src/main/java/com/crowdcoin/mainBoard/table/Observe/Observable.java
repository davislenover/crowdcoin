 ...
 */
public interface Observable<T extends ObservableEvent<? extends GeneralEventType, S>, S> {
     ...
     */
    boolean addObserver(Observer<T,S> observer);
     ...
     * @return true if the subscription list was changed as a result of invocation of this method, false otherwise
     */
    boolean removeObserver(Observer<T,S> observer);
