...
public interface GuardianHandler<T extends Throwable> {
    ...
    /**
     * Handle a given exception of type T. This method may use {@link com.crowdcoin.exceptions.handler.strategies.ExceptionStrategy} instances to handle the given exception
